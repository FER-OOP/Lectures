...
public class Problem {
	...
	/**
	 * Converts a string to integer, increments a value and prints a message on System.out.
	...
	/**
	 * Outputs the lines from the scanner. The method will terminate once the lines is equal to "q".
	 * @param s
	 */
