...
public class Solution {
	...
	public static void main(String[] args) {
		...
		// Identified problem: Student is a person, but person may not be a student. ClassCastException
		...
		// Identified problem: Iterating over an array which may not have the length of 3. In that case: ArrayIndexOutofBoundsException.
		// 	Solution 1: fix the for loop so that it does not contain a hardcoded value 
		// 	Solution 2: call the method with "correct" parameter ("correct" = an array with at least 3 elements)
		// We present solution 1, you try both. Note: solution 2 (without implementation of solution 1) is bad and should be discouraged.
		...
		// We present solution 1. Note that solution 2 is not really a solution. In general, the errors should not be catched because they indicate severe problems from which the program can't recover.
