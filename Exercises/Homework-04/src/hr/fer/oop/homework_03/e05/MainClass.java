...
import hr.fer.oop.homework_03.e04.*;
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		people[1] = new Teacher("Doris", "Bezmalinoviæ", 43, "doris.bezmalinovic@fer.hr", "OOP", 10000);
		people[2] = new Teacher("Perica", "Bebiæ", 35, "perica.bebic@fer.hr", "OOP", 9400);
		
		people[3] = new Student("Janko", "Horvat", 18, "0036312123", (short)1);
		people[4] = new Student("Ana", "Kovaè", 20, "0036387656", (short)2);
