 ...
 * Task 3
 * 
 * You need to create a garden. A garden has two plants: Violets and
 * Tomatoes. Plants first need to be grown properly, meaning that they need to
 * be watered with enough water and in a specific manner, and afterwards need to
 * be fertilized. After being grown, the plants can be plucked. Assume all
 * plants in the garden belong to the same gardener and the gardener intends to
 * keep them.
 * 
 ...
 * Zadatak 3
 * 
 * Potrebno je napraviti vrt. U vrtu se nalaze dvije biljke: Ljubičice i Rajčice.
 * Biljke je potrebno ispravno uzgojiti, što znači da ih je potrebno zaliti s
 * dovoljno vode i na određeni način. Nakon toga ih je potrebno zagnojiti. Nakon
 * što su biljke ispravno uzgojene, biljke je moguće ubrati. Pretpostavite da
 * sve biljke u vrtu pripadaju jednom vrtlaru te da ih on planira zadržati.
 * 
