 ...
 * 
 * Zadatak 1:
 * Va� zadatak je spojiti (konkatenirati) sve primljene parametre u jedan niz znakova (String) odvojene to�komzarez (CSV format), npr.
 * za primljeni niz parametara "jedan dva tri", znakovni niz bi trebao izgledati "jedan;dva;tri;". Ovaj znakvni niz koristit �e se u nastavku za podzadatke.
 * a) separacija znakovnog niza
 * 	potrebno je napisati metodu za separaciju znakovnog niza po znaku to�kezarez - ";". Dobivene dijelove isprintati na standardni izlaz
 * b) indeksOdre�enogZnaka
 * 	potrebno je napisati metodu za pronalazk prvog i zadnjeg indeksa odre�enog znaka, u ovom slu�aju to�kezarez - ";" te ih potom ispisati na po�etni ekran
 * c) podniz
 * 	potrebno je napisati metodu za pronalazak odre�enog podniza. Podniz se u ovom slu�aju sastoji od dijela iza prve to�ke zarez pa sve do zadnje to�kezarez.
